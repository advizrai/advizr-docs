...
Everything the platform does for you, from the answers your team gives to the workflows it builds, draws on the documents you add. Clean, current, well-chosen documents produce specific answers and systems that work on day one; a dump of stale files produces generic advice and rework. This guide covers what to upload, how to prepare it, and how to handle sensitive information.

The mechanics of uploading are covered in [Upload your documents](/docs/platform/onboarding/adding-sources) (during onboarding) and the [Documents section](/docs/platform/learn/brain) (any time after). This guide is about what to put in.
...
- **One current version per document.** Upload the version that reflects reality today. If you upload the wrong file, upload the correct one and tell your FDE in [Interact](/docs/platform/your-team/interact) which to disregard.
...
- **Don't over-strip.** Systems are built against your real data, and systems built against fake data break against real data. If you're unsure whether a field is needed, ask your FDE in [Interact](/docs/platform/your-team/interact) before redacting it.
...
<Callout type="warning">
  Deleting a document removes it from your Brain, so your team and its workflows stop drawing on it. If a workflow was built around a file, tell your FDE before removing it.
</Callout>
...
| Draws on your sources when answering, in workflows, and in build planning | Use clear file names and keep one current version per document |
...
[ ] Tell your FDE which documents matter most
[ ] Re-upload when a process or report changes
[ ] Remove mistaken uploads and flag them to your FDE
```

## Keep going

- [Upload your documents](/docs/platform/onboarding/adding-sources) — the upload flow, step by step
- [Documents](/docs/platform/learn/brain) — managing your library after onboarding
