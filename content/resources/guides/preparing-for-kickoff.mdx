...
If you need to reschedule, do it from [Book](/docs/platform/features/booking-and-scheduling) — moving the call costs nothing before it happens, but going in unprepared costs you the first sprint's momentum.
