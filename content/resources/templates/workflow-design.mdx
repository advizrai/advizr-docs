...
| Is the amount under your approval threshold? | Amount field vs threshold | Create draft bill directly | Route to approval gate first |
...
**Human review gates:** new suppliers, anything at or above your approval threshold, and any extraction below the confidence threshold. Everything else flows through and stays visible in the run log.
...
During week 0 of an engagement, your FDE maps your workflows in exactly this shape before anything is built — a completed worksheet shortens that work and sharpens the [first sprint](/docs/services/how-it-works). The steps marked "System" become build candidates, the decision points determine where AI judgment versus fixed rules belong, and the failure modes become test cases. If you're already a client, share completed worksheets with your FDE in [Interact](/docs/platform/your-team/interact).
