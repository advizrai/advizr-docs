...
Every system we deploy logs its own activity (runs, items processed, outcomes). Monthly, your FDE reports value delivered against the baseline: hours displaced, what those hours are worth at your own loaded cost, and the running ROI multiple. The numbers come from system logs, not estimates — you can see the run history yourself in [your dashboard](/docs/platform/engagement/runs).
