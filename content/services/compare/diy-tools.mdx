...
- **Instant start**: you can ship a Zap this afternoon on a self-serve subscription.
...
| Volume | Per-task pricing scales with every run, so the bill grows with the workload |
