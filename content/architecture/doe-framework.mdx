...
description: "Directives, Orchestration, Execution: the three-layer architecture that separates AI judgment from deterministic code in every system Advizr builds."
---
