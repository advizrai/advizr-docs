...
- **Report compromise promptly.** If you suspect an account has been accessed without authorization, tell us immediately through [Interact](/docs/platform/your-team/interact) or legal@advizr.ca. {/* GATE0: confirm contact address with James */}
...
Questions about whether a planned use is acceptable: email legal@advizr.ca, or raise it with your assigned engineer in [Interact](/docs/platform/your-team/interact). {/* GATE0: confirm contact address with James */}
