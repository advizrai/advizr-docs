...
<Details title="Can I export my data?">
  Yes. You can download your source documents at any time from the Sources tab in [Brain](/docs/platform/learn/brain). For a full data export, including conversations, goals, and activity history, ask your FDE in [Interact](/docs/platform/your-team/interact). They'll arrange the export and provide it in a standard format.
...
If you have specific compliance questions — for example, whether the platform meets requirements for your industry or jurisdiction — message your FDE in [Interact](/docs/platform/your-team/interact). They can provide detailed information about the security measures relevant to your situation.
