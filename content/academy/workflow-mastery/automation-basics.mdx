...
description: How automation works without writing code - triggers, actions, and data flow, the three automation types, and the six-step process for building one.
duration: 3 min
---
...
<Details title="Question: What are the three building blocks of every automation?">
...
<Details title="Question: What are the three types of automation?">
...
<Details title="Question: When should you use a human-in-the-loop design?">
