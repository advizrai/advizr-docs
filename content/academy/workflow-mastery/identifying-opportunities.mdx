...
description: A practical framework for spotting automation candidates - the traits to look for, the opportunity matrix, and the red-flag phrases that signal wins.
duration: 3 min
---
...
<Details title="Question: What traits do the best automation candidates share?">
...
<Details title="Question: Which quadrant of the opportunity matrix should you automate first?">
...
<Details title="Question: What is the simplest technique for finding automation candidates?">
