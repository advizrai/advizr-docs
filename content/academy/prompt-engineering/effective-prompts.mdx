...
description: The four-part prompt structure with five worked examples across sales, finance, meetings, HR, and customer support, plus tips for better results.
duration: 3 min
---
...
2. **Context** - give it background about your situation ("I run a 20-person construction company that takes on about 40 jobs a year")
3. **Task** - state exactly what you need ("Analyze this P&L and identify the 3 biggest cost reduction opportunities")
4. **Format** - describe how the output should look ("Present as a numbered list, with the estimated hours saved beside each item")
...
> You are an HR manager at a mid-size logistics company. Write a job description for a warehouse supervisor. Include: responsibilities, requirements, nice-to-haves, and shift pattern. Tone: straightforward and honest.
...
<Details title="Question: What are the four parts of the prompt structure?">
...
<Details title="Question: Do you need all four parts in every prompt?">
  No. But the more you include, the less back-and-forth you will need to get a usable result.
</Details>

<Details title="Question: What is one way to prevent common mistakes in AI output?">
