...
description: Learn the prompt-response loop and the four elements of an effective prompt - role, context, task, and format - with bad and good examples compared.
duration: 3 min
---
...
<Details title="Question: What are the four steps of the prompt-response loop?">
...
<Details title="Question: Why do most people get mediocre results from AI?">
...
<Details title="Question: What four elements separate a good prompt from a bad one?">
